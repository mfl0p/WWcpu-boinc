...
int wieferich(uint64_t p, uint64_t inverted, ulong2 & mone, uint64_t & checksum, int32_t & result, int32_t & rem, int32_t & quot){

	const uint64_t q = inverted;
...
int wallsunsun(uint64_t p, uint64_t inverted, ulong2 mone, uint64_t & checksum, int32_t & result, int32_t & rem, int32_t & quot){

	const uint64_t q = inverted;
	const ulong2 one = mone;
